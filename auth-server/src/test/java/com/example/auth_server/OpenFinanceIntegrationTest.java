...
public class OpenFinanceIntegrationTest {
    ...
    void testConsentPermissionValidation() {
        ...
        assertThrows(RuntimeException.class, () -> consentService.validateConsentForResourceAccess(
                response.getData().getConsentId(),
    ...
    void testConsentExpiration() {
        ...
        assertDoesNotThrow(() -> consentService.validateConsentForResourceAccess(consentId, "ACCOUNTS_READ"));
    ...
    void testPerformanceComparison() throws Exception {
        ...
        for (int i = 0; i < iterations; i++) {
            ...
            dilithiumSignature.verify(testData.getBytes(), sig, dilithiumSignature.getPublicKey());
        }
    ...
    private ConsentRequest createConsentRequestWithPermissions(List<String> permissions) {
