...
@Entity
@Table(name = "consent_validation_permissions")
@IdClass(ConsentValidationPermissionId.class)
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class ConsentValidationPermission {
    ...
    private ConsentValidation consentValidation;
}
